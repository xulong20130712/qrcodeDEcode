...
public final class ViewfinderView extends View {
	...
	private Bitmap resultBitmap;//将扫描的二维码拍下来
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		ScreenRate = (int)(40 * density);//将像素转换成dp
		paint = new Paint();
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawRect(frame.left, frame.top, frame.left + ScreenRate, frame.top + CORNER_WIDTH, paint);//坐标轴变了
			...
			canvas.drawText(getResources().getString(R.string.app_name), frame.left, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
